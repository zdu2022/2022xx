...
var url = 'https://ghproxy.com/https://raw.githubusercontent.com/zdu2022/2022xx/main/Study/QuestionBank.db';
...
var init_url = 'https://ghproxy.com/https://raw.githubusercontent.com/zdu2022/2022xx/main/Study/question';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('https://ghproxy.com/https://raw.githubusercontent.com/zdu2022/2022xx/main/Study/showlogs').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
...
function init() {
    ...
    threads.start(function () {
        try {
            var x = http.get('http://pc.pbelol.com/Study/replace.js').body.string();
...
var url = 'http://pc.pbelol.com/Study/QuestionBank.db';
var path = '/sdcard/QuestionBank.db';
device.wakeUpIfNeeded(); //点亮屏幕
var first = true; //记录答题的第一次
var r; // 替换用；
...
var init_true = false;
var downloadDialog = null;
var init_url = 'http://pc.pbelol.com/Study/question';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('http://pc.pbelol.com/Study/showlogs').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
