...
var url = 'https://cloud.pbelol.com/2022xx/Study/QuestionBank.db';
...
var init_url = 'https://cloud.pbelol.com/2022xx/Study/question';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('https://cloud.pbelol.com/2022xx/Study/showlogs').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
